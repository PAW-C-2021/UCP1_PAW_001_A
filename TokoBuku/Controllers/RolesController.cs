...
namespace TokoBuku.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(TokoBukuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdRole,NamaRole")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRole,NamaRole")] Role role)
        {
            if (id != role.IdRole)
            {
                return NotFound();
